...
let torontoData = "https://raw.githubusercontent.com/noelpdot/Mapping_Earthquakes/main/torontoRoutes.json";
...
// });
        ...
        L.geoJson(data, {
            ...
            onEachFeature: function(feature, layer) {
                console.log(layer);
                layer.bindPopup(
                    "<h2>Airline: " + feature.properties.airline + "</h2> <hr> <h2> Destination: " + feature.properties.dst + "</h2>"
                );
            }
        }).addTo(map);
});
